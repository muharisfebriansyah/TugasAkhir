...
class ImageExtractForm(tk.Frame):
    def __init__(self, parent, controller):
        ...
        hg.insert_header(self, 'Ekstraksi Pesan')
    ...
    def execute(self):
        ...
        # print('Waktu Komputasi :', compute_time)
        title = "Berhasil Mengekstrak Pesan"
        self.controller.show_end_frame(title, "Image", file_name, 0, 0, compute_time, 0)
