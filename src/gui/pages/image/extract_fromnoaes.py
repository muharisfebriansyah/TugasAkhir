...
from src.image.extractnoaes import Extractor
from src.helper.file import File


class ImageExtractFormnoAES(tk.Frame):
    def __init__(self, parent, controller):
        ...
        hg.insert_header(self, 'Confidentiality Pesan')
    ...
    def execute(self):
        ...
        file_name = "gambar/" + output_filename + "." + extract.extension
        ...
        compute_time1 = total_time
        title = "Selesai Pengecekan"
        self.controller.show_end_frame(title, "None", file_name, 0, 0, compute_time1, 0)
